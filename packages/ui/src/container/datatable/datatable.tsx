...
const DataTableContainer = <T,>(props: DataTableContainerProps<T>) => {
  ...
  const theme = useMemo(() => {
    return datatableTheme.withParams({
      spacing: 10,
      rowHoverColor: '#EAE6DE',
      headerHeight: '50px',
      fontFamily: 'DM Sans',
      selectedRowBackgroundColor: '#EAE6DE',
      checkboxCheckedBackgroundColor: '#1B4332',
      checkboxCheckedShapeColor: 'white',
      checkboxUncheckedBackgroundColor: 'transparent',
      checkboxUncheckedBorderColor: '#D4D0C8',
      wrapperBorderRadius: 0,
      borderRadius: 0,
      headerTextColor: '#6B7B72',
      headerFontWeight: '700',
      backgroundColor: '#FFFFFF',
      chromeBackgroundColor: '#FFFFFF',
      foregroundColor: '#1A2E23',
      headerBackgroundColor: '#F4F0E8',
      headerColumnBorder: { style: 'solid', color: '#D4D0C8' },
      rowBorder: { style: 'solid', color: '#D4D0C8' },
      columnBorder: { style: 'solid', color: '#D4D0C8' },
      wrapperBorder: {
        width: 1,
        color: '#D4D0C8',
      },
