...
const DataTableContainer = <T,>(props: DataTableContainerProps<T>) => {
  ...
  const theme = useMemo(() => {
    return datatableTheme.withParams({
      spacing: 10,
      rowHoverColor: '#1A2736',
      headerHeight: '50px',
      fontFamily: 'DM Sans',
      selectedRowBackgroundColor: '#1A2736',
      checkboxCheckedBackgroundColor: '#226DD8',
      checkboxCheckedShapeColor: 'white',
      checkboxUncheckedBackgroundColor: 'transparent',
      checkboxUncheckedBorderColor: '#2B333B',
      wrapperBorderRadius: 0,
      borderRadius: 0,
      headerTextColor: '#848A91',
      headerFontWeight: '700',
      backgroundColor: '#0A1624',
      chromeBackgroundColor: '#0A1624',
      foregroundColor: '#FFFFFF',
      headerBackgroundColor: '#141F2D',
      headerColumnBorder: { style: 'solid', color: '#2B333B' },
      rowBorder: { style: 'solid', color: '#2B333B' },
      columnBorder: { style: 'solid', color: '#2B333B' },
      wrapperBorder: {
        width: 1,
        color: '#2B333B',
      },
