      ...
      {tabs.map((tab) => {
        ...
        return (
          <Tag
            key={tab.id}
            href={tab.href}
            className='group relative flex h-[52px] items-center px-3 pb-2'
          >
            <span
              className={cn(
                'text-sm font-bold tracking-widest transition-colors group-hover:text-foreground',
