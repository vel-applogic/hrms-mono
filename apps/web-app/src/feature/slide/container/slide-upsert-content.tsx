...
import { SlideCreateRequestSchema } from '@repo/dto';
...
type FormType = z.infer<typeof SlideCreateRequestSchema>;

// ── Markdown editor field wired to the form ─────────────────────────────────
...
interface SlideUpsertContentProps {
  control: Control<FormType>;
...
export const SlideUpsertContent = ({ control, setValue, setError, errors }: SlideUpsertContentProps) => {
