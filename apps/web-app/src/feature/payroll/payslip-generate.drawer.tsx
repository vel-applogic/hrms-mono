...
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogDescription } from '@repo/ui/component/ui/dialog';
        ...
        <DialogContent className='max-w-md'>
          <DialogHeader>
            <div className='flex items-center gap-3'>
              ...
              <DialogTitle>Payslips already exist</DialogTitle>
            </div>
            <DialogDescription className='pt-1'>
              {existingPayslips.length} payslip{existingPayslips.length > 1 ? 's' : ''} already exist for{' '}
              <strong>{MONTH_LABELS[parseInt(month, 10) - 1]} {year}</strong>. Regenerating will overwrite them.
            </DialogDescription>
          </DialogHeader>
