...
const STATUS_OPTIONS: SelectOption[] = Object.values(EmployeeStatusDtoEnum).map((val) => ({
...
export function EmployeeStatusFilter({ values, onChange }: EmployeeStatusFilterProps) {
  return (
    <SelectSearchMulti
      values={values}
